...
export default function DashboardClient({ workflows: initial }: { workflows: Workflow[] }) {
                ...
                {workflows.length === 0 ? (
                    <div className="flex flex-col items-center justify-center h-full gap-4 pb-20">
                        ...
                        <p className="text-sm text-[#525252] text-center max-w-xs">
                            You have not created any workflows yet. Get started by creating your first one.
                        </p>
                        <button
                            type="button"
                            onClick={handleCreateNew}
