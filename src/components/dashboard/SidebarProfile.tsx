...
export default function SidebarProfile() {
  ...
  return (
    <div className="flex items-center gap-2.5 px-3 py-2.5 mx-1 rounded-xl hover:bg-[#1a1a1a] transition-colors cursor-pointer">
      ...
      <div className="flex flex-col min-w-0">
        <span className="text-sm text-[#e5e5e5] font-medium truncate max-w-[120px]">{name}</span>
